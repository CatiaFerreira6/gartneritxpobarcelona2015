...
.factory('app', ['$location', '$window', '$translate', function($location, $window, $translate) {
    ...
    var service = {
        ...
        getOrderByDescription: function() {
        ...
        /* Whether or not the scan button should be visible regarding the users' preferences. */
        ...
        /* Calls upon the Android interfaces to scan a barcode. */
