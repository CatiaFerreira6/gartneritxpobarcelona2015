angular.module('register', ['ngRoute', 'pascalprecht.translate'])

/* Route definition within the register attendee plugin. If an unrecoverable
 * error occurs the user is redirected to the error page otherwise the register template is shown. */
.config(['$routeProvider', function($routeProvider) {
    $routeProvider.
        when('/', {templateUrl: 'pages/register.tpl.html', controller: 'RegisterController',
            resolve: {
