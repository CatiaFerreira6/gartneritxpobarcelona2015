angular.module('demo', ['ngRoute', 'pascalprecht.translate'])
...
.config(['$routeProvider', function($routeProvider) {
    $routeProvider.
        when('/', {templateUrl: 'pages/demo.tpl.html', controller: 'DemoController',
            resolve: {
                userId: function(resolver) { return resolver.user(); },
                deviceId: function(resolver) { return resolver.device(); },
                movement: function(resolver) { return resolver.movement(); }
            }
        }).
